          ...
          <div className="container mx-auto flex flex-col lg:flex-row items-center justify-between relative z-10 py-12 lg:py-0">
            ...
            {/* <div className="w-full lg:w-1/2 animate__animated animate__fadeInDown animate__delay-0.1s mt-24">
              <div className="gradient-border">
                <div className="code-window  items-center gap-2 sm:gap-3 px-4 sm:px-6 py-2 sm:py-3 rounded-xl sm:rounded-2xl bg-gradient-to-r from-blue-700/10 to-teal-500/10 border border-blue-700/20 mb-6 sm:mb-8 backdrop-blur-md animate__animated animate__fadeInUp animate__delay-1s">
                  <div className="window-header">
                    <div className="window-dot bg-red-500"></div>
                    <div className="window-dot bg-yellow-500"></div>
                    <div className="window-dot bg-green-500"></div>
                    <span className="ml-2 pt-2 text-sm text-gray-300 flex items-center  gap-2 bg-dark/30 px-2 rounded">
